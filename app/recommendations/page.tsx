          ...
          {selectedRecommendation ? (
            ...
            <>
              <div className="card-soft stack" style={{ gap: 8 }}>
                ...
                <div className="muted">
                  {uiLanguage === "fr"
                    ? `Tu as actuellement ${totalCount} recommandation${totalCount > 1 ? "s" : ""}. Commence par celles qui portent le plus de tension, de blocage ou de potentiel immédiat.`
                    : `You currently have ${totalCount} recommendation${totalCount > 1 ? "s" : ""}. Start with the ones that carry the most tension, blockage, or immediate potential.`}
                </div>
              </div>
